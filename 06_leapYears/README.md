...
> Leap years are years divisible by four (like 1984 and 2004). However, years divisible by 100 are not leap years (such as 1800 and 1900) unless they are divisiblethis will add new value to previous value, starts at 0 PLUS first value EQUALS first value PLUS second value equals sum of first and second value and so on.  by 400 (like 1600 and 2000, which were in fact leap years). (Yes, it's all pretty confusing)
>
